...
# -*- coding: utf-8 -*-
"""
从 ontologyv7znbz Neo4j 数据库生成18类图任务测试集
"""
    ...
    def get_subgraph(self, center_node: str, max_nodes: int = 40):
        ...
        with self.driver.session(database=NEO4J_DATABASE) as session:
            ...
            for record in result:
                ...
                if from_name and to_name and len(from_name) < 60 and len(to_name) < 60:
    ...
    def get_random_entities(self, limit: int = 100):
        ...
        with self.driver.session(database=NEO4J_DATABASE) as session:
            result = session.run("""
                ...
                AND NOT n.name STARTS WITH 'iuap:'
...
def main():
    ...
    try:
        ...
        for task_type in task_types:
            ...
            while generated < samples_per_type and attempts < 30:
                attempts += 1
        ...
        output_file = 'tests/znbz_graph_testset.csv'
